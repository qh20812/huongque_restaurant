...
export default function Login() {
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    // TODO: Call /api/login to authenticate
          ...
          <div className="flex h-full flex-col items-center justify-center p-8 sm:p-12">
            <div className="w-full max-w-md">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <label className="flex flex-col">
                  <div className="flex items-center justify-between pb-2">
                    ...
                    <a className="text-sm font-medium text-primary hover:underline" href="/forgot-password">Quên mật khẩu?</a>
                  </div>
              ...
              <div className="mt-8 text-center text-sm">
                <p className="text-subtle-light dark:text-subtle-dark">Chưa có tài khoản? <a className="font-bold text-primary hover:underline" href="/register">Đăng ký ngay</a></p>
              </div>
            </div>
          </div>
        </div>
