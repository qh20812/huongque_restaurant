          ...
          <div className="flex h-full flex-col items-center justify-center p-8 sm:p-12">
            <div className="w-full max-w-md">
              ...
              <div className="mt-8 text-center text-sm">
                <p className="text-subtle-light dark:text-subtle-dark">Đã nhớ mật khẩu? <a className="font-bold text-primary hover:underline" href="/login">Quay lại đăng nhập</a></p>
              </div>
            </div>
          </div>
        </div>
